      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex shrink-0 items-center gap-2">
            <div class="relative">
              <WifiIcon class="h-8 w-8 text-green-500" />
              <span class="absolute top-0 right-0 block h-2.5 w-2.5 rounded-full bg-green-400 ring-2 ring-gray-800 animate-pulse"></span>
            </div>
            <span class="text-white font-bold text-xl">Allied Intel</span>
          </div>
...
import { Bars3Icon, BellIcon, XMarkIcon, WifiIcon } from '@heroicons/vue/24/outline'
